package com.truking.wms.tool.lanyadayingUtils;
...
import com.truking.wms.tool.utils.com.printer.io.BluetoothPort;
import com.truking.wms.tool.utils.com.printer.io.EthernetPort;
import com.truking.wms.tool.utils.com.printer.io.PortManager;
import com.truking.wms.tool.utils.com.printer.io.SerialPort;
import com.truking.wms.tool.utils.com.printer.io.UsbPort;
                    ...
                    if (sendCommand == esc) {
                        ...
                        if (currentPrinterCommand == null) {
                            ...
                            if (result == 0) {//打印机状态查询
                                ...
                                Toast.makeText(MyApp.getContext(), mode + " " + status, Toast.LENGTH_SHORT).show();
                            }
                        }
